...
from gui_treadmill_task.treadmill_task_GUI_main import TreadmillTask_GUI_main_experiment  #NEW!
...
class Run_experiment_tab(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.experiment_treadmilltask_gui=TreadmillTask_GUI_main_experiment(self)  #NEW!
        ...
        self.plots_button.clicked.connect(self.launch_plots) #NEW! to replace the previous line to launch both the original pyControl plots and the treadmill plots
    ...
    def launch_plots(self): #NEW!
        self.experiment_plot.show()   #NEW!
        self.experiment_treadmilltask_gui.show()   #NEW!
    ...
    def setup_task(self, i):
        ...
        try:
            board.data_logger = Data_logger(print_func=board.print, data_consumers=
                [self.experiment_plot.subject_plots[i], self.experiment_treadmilltask_gui.subject_plots[i], self.subjectboxes[i].task_info]) #NEW! added: self.experiment_treadmilltask_gui.subject_plots[i]
    ...
    def setup_experiment(self, experiment):
        ...
        self.experiment_treadmilltask_gui.setup_experiment(experiment) #NEW!
        ...
        self.experiment_treadmilltask_gui.set_state_machine(board.sm_info) #NEW!
    ...
    def close_experiment(self):
        ...
        self.experiment_treadmilltask_gui.close_experiment() #NEW!
        # Close boards.
    ...
    def update(self):
        ...
        self.experiment_treadmilltask_gui.update() #NEW!
        if self.setups_finished == len(self.boards):
...
class Subjectbox(QtGui.QGroupBox):
    ...
    def start_task(self):
        ...
        self.run_exp_tab.experiment_treadmilltask_gui.start_experiment(self.setup_number) #NEW!
    ...
    def stop_task(self):
        ...
        self.run_exp_tab.experiment_treadmilltask_gui.active_plots.remove(self.setup_number) #NEW!
