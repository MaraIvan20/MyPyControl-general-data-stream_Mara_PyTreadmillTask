...
from gui_treadmill_task.treadmill_task_GUI_main import TreadmillTask_GUI_main  #NEW!
...
class Run_task_tab(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.treadmilltask_gui=TreadmillTask_GUI_main()  #NEW!
        self.data_logger = Data_logger(print_func=self.print_to_log,
                                       data_consumers=[self.task_plot, self.treadmilltask_gui, self.task_info])  #NEW! added self.treadmilltask_gui
    ...
    def setup_task(self):
        ...
        try:
            ...
            self.treadmilltask_gui.set_state_machine(self.board.sm_info) #NEW!
    ...
    def start_task(self):
        ...
        self.treadmilltask_gui.run_start(recording) #NEW!
        ...
        self.treadmilltask_gui.show()  #NEW!
    ...
    def stop_task(self, error=False, stopped_by_task=False):
        ...
        self.treadmilltask_gui.run_stop() #NEW!
    ...
    def update(self):
        ...
        self.treadmilltask_gui.update() #NEW!
